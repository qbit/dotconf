...
** zig
:PROPERTIES:
:ID:       3185af97-f0b5-4d8f-80b2-85ba2dff8af2
:END:
...
**** Presentations in plain old org-mode \o/
:PROPERTIES:
:ID:       d90bf8e9-da87-4794-826a-f0d291f3955c
:END:
...
#+begin_src emacs-lisp
  ...
  (if (file-exists-p "/usr/share/emacs/site-lisp/elpa-src/mu4e-1.12.14/mu4e.el")
      (load "/usr/share/emacs/site-lisp/elpa-src/mu4e-1.12.14/mu4e.el"))
#+end_src
