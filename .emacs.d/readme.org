...
I tried using treemacs for a while, but the "project" orientation is a bit much
for what I want. dired-sidebar uses dired, so things are minimalish and quick.
